...
model = tf.keras.models.load_model(r'models\tf15gpu_EfficientNetB0_model_IntelImage.h5', compile=False)

# Image labels
with open(r'models\tf15gpu_EfficientNetB0_model_IntelImage_class_indices.json', 'r') as f:
